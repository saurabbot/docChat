...
function openAIResponseToChatMessage(message) {
    switch (message.role) {
        case "user":
            return new index_js_1.HumanChatMessage(message.content || "");
        case "assistant":
            return new index_js_1.AIChatMessage(message.content || "", {
                function_call: message.function_call,
            });
        case "system":
            return new index_js_1.SystemChatMessage(message.content || "");
        default:
